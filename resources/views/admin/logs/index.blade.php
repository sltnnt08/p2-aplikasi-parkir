...
<div class="space-y-6">
    <!-- Header -->
    <div>
        <h1 class="text-3xl font-semibold tracking-tight text-[#191c1e]">Activity Logs</h1>
    ...
    <div class="bg-white rounded-lg shadow-[0px_12px_32px_rgba(30,41,59,0.06)] p-6">
        <form method="GET" action="{{ route('admin.logs') }}" class="flex flex-col sm:flex-row gap-4 items-end">
            <div class="flex-1">
